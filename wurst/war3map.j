...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_A1P1Node1=Rect(- 1664.0, 5376.0, - 1536.0, 5504.0)
    set gg_rct_A1P1Node2=Rect(- 896.0, 4864.0, - 768.0, 4992.0)
    set gg_rct_A1P1Node3=Rect(- 1664.0, 4224.0, - 1536.0, 4352.0)
    set gg_rct_A1P1End=Rect(- 1664.0, 3296.0, - 768.0, 3488.0)
    set gg_rct_A1P1Spawn=Rect(- 1664.0, 5856.0, - 768.0, 6048.0)
endfunction
